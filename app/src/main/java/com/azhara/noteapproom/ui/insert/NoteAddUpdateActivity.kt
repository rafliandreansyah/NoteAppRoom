package com.azhara.noteapproom.ui.insert
...
import com.azhara.noteapproom.helper.DateHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_submit.setOnClickListener {
            ...
            val descriiption = edt_description.text.toString().trim()
            if (title.isEmpty()){
                edt_title.error = getString(R.string.empty)
            }else if (descriiption.isEmpty()){
                edt_description.error = getString(R.string.empty)
            }else{
                note.let { note ->
                    note?.title = title
                    note?.description = descriiption
                }
    ...
    private fun showAlertDialog(dialog: Int) {
        val isDialogClose = dialog == ALERT_DIALOG_CLOSE
